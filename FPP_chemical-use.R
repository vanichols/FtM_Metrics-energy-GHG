# title: NIR Processing - getting/processing chemical use
...
#--a list of active ingredients and their 'codes', not sure where this came from
#  or how often it needs updating
...
#--not sure why renaming columns to something harder to reference, but leave it for now
nass_chemicals <- 
  environ_collector %>%
