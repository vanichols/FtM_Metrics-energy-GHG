...
# corn - separate into silage and grain -----------------------------------
...
# sorghum - separate grain and silage -------------------------------------
...
nass_land_use_final %>% 
  write_csv("tidy_data/nass_land_use_final.csv")
